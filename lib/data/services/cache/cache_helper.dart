...
import 'i_cache_helper.dart';

@LazySingleton(as: ICacheHelper)
class CacheHelper implements ICacheHelper {
  ...
  @override
  Future<bool> saveClasses(List<ClassModel> classes) async {
  ...
  List<ClassModel> getClasses() {
    ...
    if (jsonString != null) {
      ...
      return jsonList
          .map((json) => ClassModel.fromJson(json, json['docId']))
          .toList();
    } else {
      return [];
    }
  ...
  @override
  Future<bool> removeClasses() async {
    return await sharedPreferences!.remove('classes');
  }

  @override
  Future<bool> saveQuizzes(List<QuizzesModel?> quizzes) async {
    String jsonString = jsonEncode(
  ...
  List<QuizzesModel> getQuizzes() {
    ...
    if (jsonString != null) {
      List<dynamic> jsonList = jsonDecode(jsonString);
      return jsonList
          .map((json) => QuizzesModel.fromJson(json, json['docId']))
          .toList();
    } else {
      return [];
    }
  ...
  Future<bool> saveQuizzesData(QuizzesModel quizzesModel) async {
  ...
  @override
  Future<bool> saveQuizAnswers(QuizAnswers quizAnswers) async {
  ...
  @override
  Future<bool> saveEvents(List<EventsModel?> events, String key) async {
    String jsonString = jsonEncode(
  ...
  List<EventsModel> getEvents(String key) {
    ...
    if (jsonString != null) {
      ...
      final events =
          jsonList
              .map(
                (json) => EventsModel.fromJson(json, json['docId'] ?? "", key),
              )
              .toList();
      events.sort(
  ...
  @override
  Future<bool> removeEvents(String key) async {
    return await sharedPreferences!.remove(key);
  }

  @override
  Future<bool> removeQuizzes() async {
